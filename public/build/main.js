...
/***/ function(module, exports, __webpack_require__) {
	...
	var LoginView = function (_View) {
	  (0, _inherits3.default)(LoginView, _View);
	
	  function LoginView() {
	    var options = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {};
	    (0, _classCallCheck3.default)(this, LoginView);
	
	    var _this = (0, _possibleConstructorReturn3.default)(this, (LoginView.__proto__ || (0, _getPrototypeOf2.default)(LoginView)).call(this, options));
	  ...
	  (0, _createClass3.default)(LoginView, [{
	    ...
	    value: function _init() {
	      ...
	      this._form.on('reset', function (event) {
	        event.preventDefault();
	        _this2.router.go('/register');
	      });
	    }
	  }, {
	    key: "resume",
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _playchoose = __webpack_require__(132);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _gameField = __webpack_require__(110);
	...
	var SinglePlayerView = function (_View) {
	  ...
	  (0, _createClass3.default)(SinglePlayerView, [{
	    ...
	    value: function _init() {
	      var container = document.querySelector('.content_container');
	      var gameContainer = new _block2.default('div');
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _gameFieldCell = __webpack_require__(130);
	
	var _gameFieldCell2 = _interopRequireDefault(_gameFieldCell);
	
	function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }
	
	var GameField = function (_Block) {
	  (0, _inherits3.default)(GameField, _Block);
	
	  function GameField() {
	    var options = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {};
	    (0, _classCallCheck3.default)(this, GameField);
	
	    var _this = (0, _possibleConstructorReturn3.default)(this, (GameField.__proto__ || (0, _getPrototypeOf2.default)(GameField)).call(this, 'div', options));
	
	    _this._el.classList.add('gameField');
	    _this.cells = new _map2.default();
	    if ('size' in options) {
	      _this.setSize(options.size);
	    }
	    _this._size_css = document.createElement('style');
	    _this._size_css.type = 'text/css';
	    document.getElementsByTagName('head')[0].appendChild(_this._size_css);
	    return _this;
	  }
	
	  (0, _createClass3.default)(GameField, [{
	    key: "setSize",
	    value: function setSize(newSize) {
	      this.clear();
	      for (var i = 0; i < newSize.h; i++) {
	        for (var j = 0; j < newSize.w; j++) {
	          var newCell = new _gameFieldCell2.default();
	    ...
	    value: function clear() {
	      this.cells.forEach(function (val, key) {
	        key._el.remove();
	      });
	      this.cells.clear();
	    }
...
/***/ function(module, exports, __webpack_require__) {
	...
	var GameFieldCell = function (_Block) {
	  (0, _inherits3.default)(GameFieldCell, _Block);
	
	  function GameFieldCell() {
	    var options = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {};
	    (0, _classCallCheck3.default)(this, GameFieldCell);
	
	    var _this = (0, _possibleConstructorReturn3.default)(this, (GameFieldCell.__proto__ || (0, _getPrototypeOf2.default)(GameFieldCell)).call(this, 'div', options));
	
	    _this._el.classList.add('gameFieldCell');
	    return _this;
	  }
